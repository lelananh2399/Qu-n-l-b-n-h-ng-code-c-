...
namespace Quanlybanhan.Forms
{
    public partial class frmHoaDonBan : Form
    {
        ...
        {
            //bật tắt các nút và thêm xóa các gt
            btnXoa.Enabled = false;
            btnLuu.Enabled = true;
            btnInHoaDon.Enabled = false;
            btnThem.Enabled = false;
            ResetValues(); // khởi tạo các gt control về mặc định
            txtMaHDBan.Text = Functions.CreateKey("HDB"); // sinh ra mã hóa đơn theo cách mk tạo trong funci
            LoadDataGridView();
        }
